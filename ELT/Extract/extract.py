...
def extract_matching_data(symbol=defaultSymbolStock, last_time = datetime.now()):
    intraday = vnstock.Vnstock().stock(symbol=symbol, source=dataSource).quote.intraday(symbol=symbol, page_size=10000 , last_time=None)
